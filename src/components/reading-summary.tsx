    ...
    <article className="flex flex-col mt-[76px] border-l border-gray-700">
      <section className="flex flex-col items-center pb-2 gap-5">
        ...
        <p className="flex flex-col items-center">
          <span className="leading-short text-lg text-gray-100 font-bold">Cristofer Rosser</span>
      ...
      <section className="flex flex-col px-14 py-5 gap-10">
        <div className="flex items-center gap-5">
          ...
          <p className="flex flex-col">
            <span className="text-gray-200 leading-short text-sm font-bold">3853</span>
        ...
        <div className="flex items-center gap-5">
          ...
          <p className="flex flex-col">
            <span className="text-gray-200 leading-short text-sm font-bold">10</span>
        ...
        <div className="flex items-center gap-5">
          ...
          <p className="flex flex-col">
            <span className="text-gray-200 leading-short text-sm font-bold">8</span>
        ...
        <div className="flex items-center gap-5">
          ...
          <p className="flex flex-col">
            <span className="text-gray-200 leading-short text-sm font-bold">Computação</span>
